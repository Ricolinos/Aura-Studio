...
| 0.1.2 | `v0.2.6-beta` (`FIRMWARE_VERSION`, PATCH: corrige parpadeo del OSD en "cubrir" + barra de progreso en píldora + el reproductor respeta modo/tema/acento, sin cambio de contrato — D-305/D-306 en `Aura-Firmware`) | v4 |
