...
| 0.1.2 | `v0.2.1-beta` (`FIRMWARE_VERSION`, PATCH: corrige el `rockbox.zip` de v0.2.0-beta, sin cambio de contrato — D-297/D-298/D-299 en `Aura-Firmware`, ST-018 aquí) | v4 |
