...
/// (base de datos compartida por los tres firmwares), `/.aura/thumbs/`
/// (miniaturas compartidas), `/.aura/art/` (cache maestra de imagenes,
/// ST-073 / contrato v16) y `/.aura/settings.cfg` (ajustes compartidos,
/// ST-147 / contrato v19) son propiedad del firmware aunque vivan bajo
