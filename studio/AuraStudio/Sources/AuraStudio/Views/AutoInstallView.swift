...
struct AutoInstallView: View {
    ...
    private var intro: some View {
        VStack(spacing: 24) {
            ...
            Text("Tu iPod necesita instalar Aura")
                .font(.largeTitle.bold())
            Text("Encontramos tu iPod conectado, pero su disco no tiene un sistema de archivos legible -- asi se ve en el modo bootloader, o cuando una instalacion quedo a medias. A continuacion instalaremos Aura automaticamente: se te pedira tu contraseña para preparar el disco (ese paso borra su contenido) y despues puede hacer falta el modo DFU, con guia paso a paso. Al terminar te avisaremos para que desconectes tu iPod.")
